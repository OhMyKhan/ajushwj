...
TOKEN = os.environ.get("TOKEN", 7194464904:AAF0S-B4wtD5motZXVdh3VQgyUuW7cXBYc4) # Dapatkan di @botfather
OWNER = os.environ.get("OWNER", "ownerallgc") # Isi dengan username kalian tanpa tanda @
